...
# Class for building the graph structure/ bayesian network from input file
class Graph(object):
    def __init__(self):
...
# function for iterating over all the possible combinations of random variables that have to be summed up to get marginal probabilities in send_lmda and send_pi msg
   ...
   # send_pi_msg function according to the pseudo code                     
    ...
    # send_lmda_msg function according to the pseudo code
    def send_lmda_msg(self, child, parent):
     ...
     # initializing the network based on the pseudo code's init function   
    ...
    # updating the network whenever we get a new instantiation (according to the pseudo code)  
...
file_address_1 = 'C:\\Users\\Anirudh Shaktawat\\Desktop\\pgm_p1_in1.txt'
file_address_2 = 'C:\\Users\\Anirudh Shaktawat\\Desktop\\pgm_p1_in2.txt'
